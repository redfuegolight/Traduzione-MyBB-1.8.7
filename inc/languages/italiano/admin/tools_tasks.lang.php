...
// Ultima modifica: Sat, 12 Mar 2016 18:38:25 +0000
// --------------------------------------------------------------------------------
...
$l['confirm_task_enable'] = '<strong>ATTENZIONE:</strong> stai per abilitare un task progettato per essere eseguito solo via cron (Vai al <a href="http://docs.mybb.com/Help-Task_System.html" target="_blank">MyBB Docs</a> per ulteriori informazioni). Continuare?';
